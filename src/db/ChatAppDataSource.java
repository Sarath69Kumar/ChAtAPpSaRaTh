...
public class ChatAppDataSource {
	...
	public static DataSource setupDataSource()
	{
        ...
        System.out.println("ChatAppDataSource :: setupDataSource");
        return dataSrc;
    }
	...
	public static Connection getConnection() throws SQLException 
	{
		...
		System.out.println("ChatAppDataSource :: getConnection");
		return dataSrc.getConnection();
	}

	private static Properties loadJdbcProperties() 
	{
		System.out.println("ChatAppDataSource :: loadJdbcProperties");
	...
	{
		System.out.println("ChatAppDataSource :: getProp");
