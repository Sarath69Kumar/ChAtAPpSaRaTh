...
<script>
	...
	var webSocket = new WebSocket("ws://localhost:8080/ChAtAPpSaRaTh/sendMessage");
...
<body>
	<a href="${pageContext.request.contextPath}/logoutprocess"
		style="font-size: 25px; float: right">Logout</a>
	...
	<div id="center">
		...
		<div class="onlineUsersDIV">
			...
			<form>
				<input id="textSubmit" class="login-submit" type="button"
					value="Refresh Online Users" />
			</form>
		</div>
	</div>
